...
export default function MercadoPage() {
  ...
  useEffect(() => {
    const socket = new WebSocket(
      "ws://localhost:8000/api/v1/market/quotes?symbols=AAPL,NVDA,TSLA,BTC-USD"
    );
    ...
    <div className="p-6 space-y-6 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        {filtered.map((asset) => (
          <div
            key={asset.symbol}
            className="bg-[#081018] border border-[#1f2a37] rounded-2xl p-5 transition-all duration-300 hover:border-cyan-500"
          >
      ...
      <div className="bg-[#081018] border border-[#1f2a37] rounded-2xl p-6 h-[500px]">
        ...
        <div className="h-full flex items-center justify-center text-gray-500">
          Próximamente: TradingView Heatmap + análisis IA
        </div>
